const descProcedimento = "A rinoplastia é uma cirurgia que remodela o nariz, melhorando a aparência e a função respiratória. O pós-operatório exige cuidados específicos para garantir resultados satisfatórios.";
...
const descProcCard01 = "Avaliação da estrutura nasal e planejamento personalizado para atender expectativas estéticas e funcionais.";

const descProcCard02 = "Exames pré-operatórios e orientações sobre dieta, medicamentos e preparação física e emocional.";

const descProcCard03 = "Cirurgia para remodelar o nariz, com técnicas personalizadas para resultados naturais e funcionais.";

const descProcCard04 = "Cuidados como repouso, compressas frias, higiene nasal e proteção solar para uma recuperação segura.";
